...
<?php foreach($rapports as $rapport):?>
  <div class="container overflow-auto m-2">
    <div class="col-sm-12">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title" name="poste"><?php echo $rapport['poste'];?></h5>
          <textarea name="rapport" cols="185" rows="5"><?php echo $rapport['rapport'];?></textarea>
          <br><br>
          <label for="date" name="date"><?php echo $rapport['date'];?></label>
          <br><br>
          <div class="d-flex">
