...
if ($_SERVER['REQUEST_URI'] == "/FIL-ROUGE/login" || $_SERVER['REQUEST_URI'] == "/FIL-ROUGE/" || $_SERVER['REQUEST_URI'] == "/FIL-ROUGE/home" || $_SERVER['REQUEST_URI'] == "/FIL-ROUGE/404") {
  ...
  $pages= ['home','login','dashboard','agents','addagent','updateagent','deleteagent','anomalies','rapports','addrapport','updaterapport','deleterapport','releves','addreleve','updatereleve','deletereleve','404','logout'];
   if(isset($_GET['page'])){
